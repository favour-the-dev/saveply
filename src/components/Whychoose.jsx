                ...
                <div className='flex w-full'>
                    ...
                    <SwiperSlide>
                        <div className='bg-yello flex items-center justify-between md:gap-2 rounded-lg p-4 md:p-8'>
                            ...
                            <div className='w-1/2'>
                            <a href="https://www.freepik.com/free-vector/files-sent-concept-illustration_11121750.htm#query=easy%20and%20convenient%20illustration&position=4&from_view=search&track=ais"><img src={img2} alt="" className='mx-auto w-full rounded-3xl md:w-2/3'/></a>
                            </div>
                        </div>
                    </SwiperSlide>
                    <SwiperSlide>
                        <div className='bg-black flex items-center justify-between gap-2 rounded-lg p-4 md:p-8'>
                            <div className='w-1/2'>
